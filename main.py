...
parser = argparse.ArgumentParser(description='Aspect-enhanced Explainable Recommendation with Multi-modal Contrast Learning (SERMON)')
...
# with open('/home/wangshuo/codes/PETER_79/cells_corpus.pkl','rb') as f:
...
# user_aspect_top2=pd.read_pickle("/home/wangshuo/dataset/data/yelp2019/yelp_user_aspects_top2.pkl")
...
model = SERMON(args.peter_mask, src_len, tgt_len, pad_idx, nuser, nitem, ntokens, args.emsize, args.nhead, args.nhid, args.nlayers, word2idx, idx2word, device, args.output, args.dropout).to(device)
